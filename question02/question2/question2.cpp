...
std::atomic<size_t> sum(0);//made sum to be atomic which means it can be read and written concurrently in different threads
...
int main(int argc, char** argv)
{
	...
	std::thread t1{ operation1,OP1_PARAM };//creates a new thread object and pass operation1 to be called
	std::thread t2{ operation2,OP2_PARAM };//creates a new thread object and pass operation2 to be called
